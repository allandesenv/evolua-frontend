...
class _ResetPasswordPageState extends ConsumerState<ResetPasswordPage> {
  ...
  Future<void> _submit() async {
    ...
    if (widget.token == null || widget.token!.isEmpty) {
      AppSnackBar.show(
        context,
        message: context.l10n.resetPasswordInvalidLink,
    ...
    try {
      ...
      AppSnackBar.show(
        context,
        message: context.l10n.resetPasswordCompletedSnack,
      ...
      AppSnackBar.show(
        ...
        message: extractApiErrorMessage(
          error,
          fallback: context.l10n.resetPasswordError,
        ),
        icon: Icons.info_outline_rounded,
      );
    } finally {
      ...
      child: Center(
        child: SingleChildScrollView(
          ...
          child: ConstrainedBox(
            ...
            child: PrimaryPanel(
              semanticLabel: context.l10n.resetPasswordSemanticLabel,
              padding: const EdgeInsets.all(24),
              child: _completed
  ...
  Widget _formContent(BuildContext context) {
    return Form(
      ...
      child: Column(
        ...
        children: [
          Text(
            context.l10n.resetPasswordCreateTitle,
          ...
          Text(
            context.l10n.resetPasswordCreateBody,
  ...
  Widget _successContent(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(context.l10n.resetPasswordSuccessBody),
        const SizedBox(height: 18),
        SizedBox(
          width: double.infinity,
          child: ElevatedButton(
            onPressed: () => context.go('/auth'),
            child: Text(context.l10n.authLoginTab),
          ),
        ),
      ],
    );
